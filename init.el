...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (highlight-numbers all-the-icons ac-slime slime-repl undo-tree company-c-headers neotree slime-company highlight-quoted flx flx-ido flycheck-clojure tagedit smex rainbow-delimiters projectile paredit magit ido-ubiquitous clojure-mode-extra-font-locking cider))))
(custom-set-faces
